            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header">
                        ...
                        <a style="float:right;" href="{{route('meal.show')}}"><button class="bnt btn-info btn-default"
                            ...
                            @foreach ($order as $row)
                                <tr>
                                    ...
                                    @if ($row->status == 'تتم مراجعة الطلب')
                                        ...
                                        <td class="text-light bg-secondary"></td>

                                    @endif

                                    @if ($row->status == 'رفض')

                                        <td class="text-light bg-danger"></td>
...
{{--                                        هاي منعمل هاي الطريقة وبالكونترولر مناخد الريكويست تبعا يا اما منعمل طريقة action فوق ومناخد الid ونحنا رايحين عالكونترولر الطريقة العادية يعني--}}
