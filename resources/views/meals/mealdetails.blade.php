                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h3> <strong style="color: seagreen ; font-size: 22px  ">نوع الوجبة :
                                    </strong>{{ $meal->category->cat_name }}</h3>
                                </p>
                            ...
                            <div class="col-md-6">
                                <img src="{{ asset('images/meals/'.$meal->image) }}" class="img-thumbnail" style="width: 500px ">
                            </div>
                        ...
                        @if (Auth::check())
                            <form action="{{route('order.store')}}" method="post">
                                ...
                                <div class="form-group ">
                                    ...
                                    <p class="text-center">
                                        <button class="btn btn-success" type="submit" style="font-size: 20px">اطلب الأن</button>
                                    </p>
